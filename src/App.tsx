...
const viewTypes = {
  ...
  interface NavMenuProps {
    item: any; key: any;  keyPath: any; selectedKeys: any; domEvent: any; 
  }
...
const App: React.FC = () => {
  ...
  const menuClicked = ({ item }:NavMenuProps) => {
    console.log(item.props.itemx);
    history.push(item.props.itemx.url); 
  };
          ...
          <Col flex="1 1 200px">
            ...
            >
              <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                ...
                >
                  <div className="input-wrapper">
                    <span className="input-label">Ready for Service Date:</span>
          ...
          <Row className="w-100" gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col flex="1 1 200px">
              <Space direction="vertical" size={24}>
                  ...
                  >
                    <Space direction="vertical" size={24}>
                      ...
                      <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                        ...
                        >
                          <div className="input-wrapper">
                            <span className="input-label">Postal Address:</span>
                            <Input size="large" className="w-100" />
                          </div>
                        </Col>
                ...
                <div className="section-card">
                  <span className="ant-modal-card-title">Primary Contact</span>
                  <div className="h-8" />
                  <div
                    className="dashboard-card shadow-1"
                    style={{
                ...
                <div className="section-card">
                  <span className="ant-modal-card-title">Billing Contact</span>
                  <div className="h-8" />
                  <div
                    className="dashboard-card shadow-1"
                    style={{
